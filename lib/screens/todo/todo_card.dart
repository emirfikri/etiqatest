                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ToDoTime(
                          label: "Start Date",
                          time: DateFormat('dd MMM yyyy').format(startDate)),
                      ToDoTime(
                          label: "End Date",
                          time: DateFormat('dd MMM yyyy').format(endDate)),
                      ToDoTime(
                          label: "Time Left",
                          startDate: startDate,
                          endDate: endDate,
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                            color: checkBoxValue ? korange : Colors.black),
                      ),
                    ],
                  ),
                  Row(
                  ...
                  Row(children: <Widget>[
                    GestureDetector(
                      ...
                      child: const SizedBox(
                          height: 17.5, width: 17.5, child: Icon(Icons.delete)),
                    )
                  ]),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        Text(label,
            style: const TextStyle(
                fontSize: 14, fontWeight: FontWeight.bold, color: klightGray)),
        const SizedBox(height: 10),
        if (showTimer)
          CountdownTimer(
            endTime: endTime,
